<template>
    ...
    <q-layout class="static-bg fullscreen">
      ...
      <div class="layout-padding">
        ...
        <div class="layout-padding" style="font-weight:bold">
          <p> Quack built the Quack app as a Free app. This SERVICE is provided by Quack at no cost and is intended for use as is.
          </p>
          ...
          <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Quack unless otherwise defined in this Privacy Policy.</p>
